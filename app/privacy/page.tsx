...
export default function PrivacyPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className={`text-4xl font-bold mb-6 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>Privacy Policy</h1>
      ...
      <div className="max-w-3xl mx-auto space-y-6 text-gray-300">
        ...
        <section>
          <h2 className={`text-2xl font-semibold mb-2 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>Information We Collect</h2>
          <p>
        ...
        <section>
          <h2 className={`text-2xl font-semibold mb-2 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>How We Use Information</h2>
          <p>
        ...
        <section>
          <h2 className={`text-2xl font-semibold mb-2 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>Cookies and Tracking</h2>
          <p>
        ...
        <section>
          <h2 className={`text-2xl font-semibold mb-2 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>Third-Party Services</h2>
          <p>
        ...
        <section>
          <h2 className={`text-2xl font-semibold mb-2 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>Security</h2>
          <p>
        ...
        <section>
          <h2 className={`text-2xl font-semibold mb-2 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>Your Rights</h2>
          <p>
        ...
        <section>
          <h2 className={`text-2xl font-semibold mb-2 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>Children</h2>
          <p>
        ...
        <section>
          <h2 className={`text-2xl font-semibold mb-2 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>Changes to This Policy</h2>
          <p>
