          ...
          <ul className="grid grid-cols-5 py-2">
            ...
            <li>
              <Link href="/manage" className="flex flex-col items-center gap-1 text-[10px]" onClick={() => setIsMenuOpen(false)}>
                <svg viewBox="0 0 24 24" className={`h-5 w-5 translate-y-0.5 ${pathname === '/manage' ? currentTheme.text : 'text-gray-400'}`} aria-hidden="true">
                  <path d="M9 18a3 3 0 1 1 0-6c.35 0 .68.06 1 .18V5l10-2v9" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M19 16a3 3 0 1 1 0-6c.35 0 .68.06 1 .18V3" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
