...
export default function AboutPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className={`text-4xl font-bold mb-8 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>About KJBeats</h1>
      <div className="max-w-3xl mx-auto">
        ...
        <h2 className={`text-2xl font-bold mb-4 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>Our Mission</h2>
        <p className="text-gray-300 text-lg mb-6">
        ...
        <h2 className={`text-2xl font-bold mb-4 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>What We Offer</h2>
        ...
        <div className="bg-gray-800 p-6 rounded-lg mt-8 border border-gray-700">
          <h2 className={`text-2xl font-bold mb-4 bg-gradient-to-r ${currentTheme.gradient} text-transparent bg-clip-text`}>Get in Touch</h2>
          <p className="text-gray-300 text-lg">
            Have questions or suggestions? We&apos;d love to hear from you! Reach out to us at{' '}
            <a href="mailto:kjbook04@gmail.com" className={`${currentTheme.text} ${currentTheme.textHover} transition-colors`}>
              kjbook04@gmail.com
            </a>
          </p>
        </div>
